$('#osclasgap_page_setup').live('pageshow',function(){
	try {
		// @todo - perform system connect test to osclasgap.org
	  	// @todo - implement a service resource that performs an initial system connect handshake
	}
	catch (error) {
		console.log("osclasgap_page_setup");
		console.log(error);
	}
});

// when the site url text field is clicked...
$('#osclasgap_page_setup_site_url').live('click',function(){
	
	// remove 'osclasgap.org' from the text field for quick-n-easy user experience
	if ($('#osclasgap_page_setup_site_url').val() == "http://www.osclasgap.org")
		$('#osclasgap_page_setup_site_url').val("http://www.");
		
});

$('#osclasgap_page_setup_connect').live('click',function(){
	try {
		
		// grab input url and validate
		// @todo - better validation here
		var url = $('#osclasgap_page_setup_site_url').val();
	  	...
	  	options = {
	  		...
	  		"success":function(inner_data){
		  		...
		  		osclasgap_services_resource_system_connect.resource_call(inner_options);
	  		},
	  	};
	  	osclasgap_services_system_connect.resource_call(options);
	}
	catch (error) {
		console.log("osclasgap_page_setup_connect");
		console.log(error);
	}
	return false;
});

$('#osclasgap_page_setup_help').live('click',function(){
